      ...
      child: Column(
        ...
        children: [
          ...
          CardItem(
            ...
            onTap: () => buildlaunchURL(context, 'tel:09123456789'),
          ),
          ...
          CardItem(
            ...
            onTap: () => buildlaunchURL(context, 'mailto:info@propertyapp.com'),
          ),
          const SizedBox(height: 16),
          CardItem(
            icon: Icons.language,
            ...
            onTap: () => buildlaunchURL(context, 'https://www.propertyapp.com'),
          ),
          const SizedBox(height: 40),
          Text(
            '© 2025 ${'app.title'.tr()}',
